...
import lk.grandhotel.stayease.databinding.ActivityAdminResetPasswordBinding;
...
public class AdminResetPasswordActivity extends AppCompatActivity {
    ...
    private ActivityAdminResetPasswordBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAdminResetPasswordBinding.inflate(getLayoutInflater());
        ...
        viewModel.resetResult.observe(this, success -> {
            ...
            if (Boolean.TRUE.equals(success)) {
                new MaterialAlertDialogBuilder(this)
                        ...
                        .setMessage("Your admin password has been reset successfully.")
